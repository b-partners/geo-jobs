...
public class DetectedImageDraw
  ...
  public File apply(
    ...
    g2d.setFont(new Font("Arial", PLAIN, 12));
  ...
  private Color getColor(DetectableType detectableType) {
    return switch (detectableType) {
      case HUMIDITE, HUMIDITE_CLAIR, HUMIDITE_INTENSE -> RED;
      case MOISISSURE, MOISISSURE_CLAIR, MOISISSURE_COULEUR, MOISISSURE_NOIRCIE -> GRAY;
      case OBSTACLE, CHEMINEE, PANNEAU_PHOTOVOLTAIQUE, VELUX -> BLUE;
      default -> ORANGE;
    };
  }
}
