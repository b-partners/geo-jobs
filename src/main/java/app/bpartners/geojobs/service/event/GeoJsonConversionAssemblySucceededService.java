...
public class GeoJsonConversionAssemblySucceededService implements Consumer<GeoJsonConversionAssemblySucceeded> {
    ...
    public void accept(GeoJsonConversionAssemblySucceeded event) {
        ...
        var formattedCreationDatetime = DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm:ss").format(creationDatetime);
        ...
        mailer.accept(
                new Email(
                        ...
                        List.of(),
                        String.format("Analyse sur l'adresse %s terminée le %s", zoneName, formattedCreationDatetime),
                        null,
                        List.of()));
    }
}
