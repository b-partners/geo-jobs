...
public class AnnotationTaskRetrievingSubmittedService
  ...
  public void accept(AnnotationTaskRetrievingSubmitted submitted) {
    ...
    var annotationRetrievingJobId = submitted.getAnnotationRetrievingJobId();

    annotationRetrievingJobService.fireTasks(annotationRetrievingJobId);

    //    var annotationJobId = submitted.getAnnotationJobId();
    //    var imageWidth = submitted.getImageWidth();
    //
    //    annotationService.fireTasks(humanZdjId, retrievingJob.getId(), annotationJobId,
    // imageWidth);
  }
}
