...
public class AnnotatorApiClient {
    ...
    public AnnotatorApiClient(
            @Value("${annotator.api.url}") String annotatorApiUrl) {
    ...
    public List<Task> getTasksByJobId(String jobId,
                                      String userId,
                                      TaskStatus status,
                                      Integer page,
                                      Integer pageSize) {
    ...
    public List<AnnotationBatch> getAnnotationBatches(String jobId,
                                                      String taskId,
                                                      Integer page,
                                                      Integer pageSize) {
        try {
    ...
    private String computeGetTaskByJobIdQueryParams(String userId, TaskStatus status, Integer page, Integer pageSize) {
    ...
    private String queryParameters(Map<String, String> queryParams) {
        String queryStringValue = queryParams.entrySet().stream()
