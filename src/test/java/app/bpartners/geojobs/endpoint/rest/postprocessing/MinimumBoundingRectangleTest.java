...
public class MinimumBoundingRectangleTest {
    public MinimumBoundingRectangle degrees45() {
        ...
        return new MinimumBoundingRectangle(new TiledPolygon(polygon, tombe, new IntXY(0, 0), TilingConf.getDefaultInstance()));
    }
    ...
    void transform_45_to_eq() {
        ...
        var fromEq = new MinimumBoundingRectangleEq(degrees45().getCenter(), tombe, new IntXY(0, 0), angle, 2500)
    ...
    void transform_90_to_eq() {
        ...
        var fromEq = new MinimumBoundingRectangleEq(degrees90().getCenter(), tombe, new IntXY(0, 0), angle, 2500)
    ...
    void transform_300_to_eq() {
        ...
        var fromEq = new MinimumBoundingRectangleEq(degrees300().getCenter(), tombe, new IntXY(0, 0), angle, 2500)
